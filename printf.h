...
/*   Updated: 2020/01/15 21:35:35 by rgwayne-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							ft_width(t_struct *inform, char *format,\
t_buff *buff_size, va_list list);
int							ft_modifiers(char *format, t_struct *inform,\
t_buff *buff_size, va_list list);
void						ft_make_arg(t_struct *inform,\
t_buff *buff_size, int len);
int							ft_value_maker(t_struct *inform,\
t_buff *buff_size, va_list list);
...
char						*word_maker(t_struct *inform,\
char *buffer, int len);
...
t_struct *inform);
char						*start_by_width(t_struct *inform,\
char *buffer, int len);
char						*start_by_neg_width(t_struct *inform,\
char *buffer, int len);
char						*start_by_neg_width2(t_struct *inform, char *str,\
...
*inform, int len);
char						*ft_flags(char *str, t_struct *inform,\
int i, int len);
char						*ft_zeroes(char *s1, t_struct *inform, int len);
char						*start_by_prec(t_struct *inform,\
char *buffer, int len);
char						*start_by_len(t_struct *inform,\
char *buffer, int len);
...
char						*ft_widther(t_struct *inform, char *buffer,\
int len);
char						*ft_minus_widther(t_struct *inform, char *buffer,\
int len);
